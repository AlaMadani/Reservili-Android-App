...
public class DetailSpectacleFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        Button btnSite = view.findViewById(R.id.btnOfficialSite);
        btnSite.setOnClickListener(v -> {
            Intent intent = new Intent(Intent.ACTION_VIEW);
            intent.setData(Uri.parse("https://festivaldecarthage.tn/"));
            startActivity(intent);
        });
        progressBar = view.findViewById(R.id.loadingOverlayyy);
