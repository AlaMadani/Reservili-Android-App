...
public class HomeFragment extends Fragment {
    ...
    private String sortOption    = "Dates Croissantes";
    ...
    private void togglePopup(View anchor) {
        if (popupWindow != null && popupWindow.isShowing()) {
            ...
            List<String> cities = Arrays.asList(
                    "Toutes", "Tunis", "Sfax", "Sousse", "Bizerte", "Monastir", "Ariana", "Gabes","Mahdia"
            );
            List<String> sortOptions = Arrays.asList(
                    "Dates Croissantes", "Dates Decroissantes", "Heures Croissantes", "Heure Decroissantes"
            );
